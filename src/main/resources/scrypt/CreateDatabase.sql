...
('admin1', 'Admin', 'Super', 'admin@example.com', '0600000001', '1 rue de l Admin', '75001', 'Paris', '{bcrypt}$2a$10$Fu/9x1LZ6nTvwN4RlR2pXe9MLVP80pfFDE5y8mnqbU.vo8mjj7vSG', 100, 1),
('user1', 'Durand', 'Jean', 'user1@example.com', '0600000002', '2 rue de Paris', '75002', 'Paris', '{bcrypt}$2a$10$Fu/9x1LZ6nTvwN4RlR2pXe9MLVP80pfFDE5y8mnqbU.vo8mjj7vSG', 100, 0),
('user2', 'Dupont', 'Marie', 'user2@example.com', '0600000003', '3 rue de Lyon', '69001', 'Lyon', '{bcrypt}$2a$10$Fu/9x1LZ6nTvwN4RlR2pXe9MLVP80pfFDE5y8mnqbU.vo8mjj7vSG', 100, 0),
('user3', 'Martin', 'Paul', 'user3@example.com', '0600000004', '4 rue de Marseille', '13001', 'Marseille', '{bcrypt}$2a$10$Fu/9x1LZ6nTvwN4RlR2pXe9MLVP80pfFDE5y8mnqbU.vo8mjj7vSG', 100, 0),
('user4', 'Lemoine', 'Sophie', 'user4@example.com', '0600000005', '5 avenue de Lille', '59000', 'Lille', '{bcrypt}$2a$10$Fu/9x1LZ6nTvwN4RlR2pXe9MLVP80pfFDE5y8mnqbU.vo8mjj7vSG', 100, 0),
...
('Ordinateur Portable', 'PC portable performant avec processeur i7 et SSD 512Go.', '2025-02-10', '2025-02-20', 800, NULL, 1, 1),
('Table Basse', 'Table basse en bois massif, style scandinave.', '2025-02-12', '2025-02-22', 150, NULL, 2, 2),
('T-shirt Noir', 'T-shirt en coton bio, taille M.', '2025-02-11', '2025-02-18', 20, NULL, 3, 3),
('Vélo de Route', 'Vélo de course en carbone, très léger.', '2025-02-13', '2025-02-25', 1200, NULL, 4, 4),
('Casque Gaming', 'Casque audio avec micro et réduction de bruit.', '2025-02-15', '2025-02-28', 90, NULL, 5, 1),
('Chaise Design', 'Chaise moderne avec assise rembourrée.', '2025-02-14', '2025-02-24', 80, NULL, 6, 2),
('Jean Slim', 'Jean coupe slim, couleur bleu foncé.', '2025-02-10', '2025-02-19', 50, NULL, 7, 3),
('Raquette de Tennis', 'Raquette légère et maniable pour joueurs confirmés.', '2025-02-16', '2025-02-26', 200, NULL, 8, 4),
('Montre Connectée', 'Montre intelligente avec suivi d activité et notifications.', '2025-02-17', '2025-02-27', 250, NULL, 9, 1),
('Canapé 3 Places', 'Canapé en tissu gris avec coussins confortables.', '2025-02-18', '2025-02-28', 500, NULL, 10, 2),
('Sweat à Capuche', 'Sweat unisexe en coton, couleur gris chiné.', '2025-02-19', '2025-02-28', 40, NULL, 11, 3),
('Tapis de Yoga', 'Tapis antidérapant idéal pour le yoga et le fitness.', '2025-02-20', '2025-02-28', 30, NULL, 12, 4),
('Smartphone', 'Téléphone haut de gamme avec écran OLED.', '2025-02-21', '2025-02-28', 900, NULL, 13, 1),
('Bureau en Bois', 'Bureau minimaliste en chêne avec tiroirs.', '2025-02-22', '2025-02-28', 300, NULL, 14, 2),
('Chaussures de Sport', 'Baskets légères pour la course à pied.', '2025-02-23', '2025-02-28', 120, NULL, 15, 3),
('Sac à Dos', 'Sac à dos robuste pour ordinateur et accessoires.', '2025-02-24', '2025-02-28', 70, NULL, 16, 1),
('Lunettes de Soleil', 'Lunettes de soleil polarisées avec protection UV.', '2025-02-25', '2025-02-28', 60, NULL, 17, 3),
('Tondeuse à Gazon', 'Tondeuse électrique puissante et silencieuse.', '2025-02-22', '2025-02-28', 400, NULL, 18, 4),
('Casque Bluetooth', 'Casque sans fil avec autonomie de 30h.', '2025-02-20', '2025-02-28', 150, NULL, 19, 1),
('Armoire Penderie', 'Grande armoire en bois avec miroir.', '2025-02-20', '2025-02-28', 600, NULL, 20, 2);
...
(18, 9, '2025-02-17', 260),
(19, 9, '2025-02-18', 280),
(20, 10, '2025-02-18', 520),
(1, 10, '2025-02-19', 550),
(3, 11, '2025-02-19', 45),
(5, 11, '2025-02-20', 50),
(7, 12, '2025-02-20', 35),
(9, 12, '2025-02-21', 40),
(11, 13, '2025-02-21', 920),
(13, 13, '2025-02-22', 950),
(15, 14, '2025-02-22', 320),
(17, 14, '2025-02-23', 340),
(19, 15, '2025-02-23', 130),
(1, 15, '2025-02-24', 140),
(2, 16, '2025-02-24', 75),
(4, 16, '2025-02-25', 80),
(6, 17, '2025-02-25', 65),
(8, 17, '2025-02-26', 70),
(10, 18, '2025-02-26', 420),
(12, 18, '2025-02-27', 450),
(14, 19, '2025-02-27', 160),
(16, 19, '2025-02-28', 170),
(18, 20, '2025-02-28', 620),
(20, 20, '2025-02-28', 650);
